...
namespace Banico.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20200104000436_Owners")]
            ...
            modelBuilder.Entity("Banico.Core.Entities.Config", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "f457c4b6-589a-4018-a41d-9e331fef6fd9",
                            CreatedDate = new DateTimeOffset(new DateTime(2020, 1, 4, 0, 4, 35, 615, DateTimeKind.Unspecified).AddTicks(9940), new TimeSpan(0, 0, 0, 0, 0)),
                            Module = "",
                            Name = "initialized",
                        ...
                        new
                        {
                            Id = "bcbbd786-5123-46b5-bc3c-92a2f4090fc7",
                            CreatedDate = new DateTimeOffset(new DateTime(2020, 1, 4, 0, 4, 35, 616, DateTimeKind.Unspecified).AddTicks(9650), new TimeSpan(0, 0, 0, 0, 0)),
                            Module = "admin",
                            Name = "canActivate",
                            UpdatedDate = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Value = "admin"
